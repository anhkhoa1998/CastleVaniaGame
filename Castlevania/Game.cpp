...
void Game::InitKeyboard(LPKEYEVENTHANDLER handler)
{
	...
	if (hr != DI_OK)
	{
		MessageBox(NULL, L"Tao1KhongThanhCong", L"Caption of STDIO.VN", MB_OK);
		return;
	}
	...
	if (hr != DI_OK)
	{
		MessageBox(NULL, L"Tao2KhongThanhCong", L"Caption of STDIO.VN", MB_OK);
		return;
	}
	...
	if (hr != DI_OK)
	{
		MessageBox(NULL, L"Tao3KhongThanhCong", L"Caption of STDIO.VN", MB_OK);
		return;
	}
